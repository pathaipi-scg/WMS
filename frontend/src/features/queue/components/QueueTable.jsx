...
import { QueueStatusBadge } from '../../../shared/components/QueueStatusBadge';
    ...
    <>
      <div className="flex flex-col h-full w-full max-w-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div className="queue-scrollbar relative flex-1 min-h-0 overflow-auto">
          <table className="table-fixed w-full min-w-290 text-left text-xs">
            <colgroup>
              <col className="w-12" />
              <col className="w-20" />
              <col className="w-18" />
            ...
            <thead className="sticky top-0 z-10 bg-gray-50 text-gray-500 font-medium border-b border-gray-100">
              <tr>
                ...
                <th className="p-3 text-center whitespace-nowrap">เวลารอ (นาที)</th>
                <th className="p-3 text-center whitespace-nowrap">คาดว่าเสร็จ</th>
                <th className="p-3 text-center whitespace-nowrap">CPAC</th>
                <th className="p-3 text-center whitespace-nowrap">PRESTIGE</th>
                <th className="p-3 text-center whitespace-nowrap">NEUSTILE</th>
                <th className="p-3 text-center whitespace-nowrap">FITTING</th>
                <th className="p-3 text-center whitespace-nowrap">ACCESSORIES</th>
