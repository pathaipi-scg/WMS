...
import { buildYardDetailsViewModel } from '../../../utils/yard/yardDetailsModel';
import { YardSlotStatusBadge } from '../../common/YardSlotStatusBadge';
...
export const YardDetailsModal = memo(function YardDetailsModal({ bay, isOpen, onClose }) {
  ...
  // component แสดงรายละเอียดของช่องจ่าย
    ...
    <BottomSheet isOpen={isOpen} onClose={onClose}>
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-start gap-4">
          <YardSlotStatusBadge status={bay.status} label={bay.statusLabel} size="lg" />
        </div>
      </div>
      ...
      <div
        ...
        style={
          leftColumnHeight
            ? { '--yard-detail-column-height': `${leftColumnHeight}px` }
            : undefined
        }
      >
        <section ref={leftColumnRef} className="space-y-4 xl:col-span-3">
          <div className="rounded-[11px] border border-slate-200 bg-gray-50 p-5">
        ...
        <section className="rounded-[11px] border border-slate-200 bg-gray-50 p-5 xl:col-span-3 xl:flex xl:h-(--yard-detail-column-height) xl:flex-col">
