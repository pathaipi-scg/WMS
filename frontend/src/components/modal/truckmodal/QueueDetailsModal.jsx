...
import { Check, CircleUserRound, Clock, MapPin, Megaphone, Package, Package2, SquareArrowRightExit, Truck } from 'lucide-react';
import { buildQueueDetailsViewModel, getLoadingItemStatusClassName } from '../../../utils/queue/queueDetailsModel';
import {
  getStepClassName,
  getStepLabelClassName,
  getTimelineProgressWidth,
} from '../../../utils/queue/timelineStyles';
import { QueueStatusBadge } from '../../common/QueueStatusBadge';
import { BottomSheet } from '../../common/BottomSheet';
// Component สำหรับแสดง modal รายละเอียดของคิวรถ

const TIMELINE_ICONS = [Clock, Megaphone, Package, Check, SquareArrowRightExit];
  ...
  return (
    <BottomSheet isOpen={!!queue} onClose={onClose}>
      ...
      <div className="mt-4 grid grid-cols-1 gap-5 xl:grid-cols-12">
        <section className="rounded-[11px] border border-slate-200 bg-gray-50 p-5 xl:col-span-4">
        ...
        <section className="rounded-[11px] border border-slate-200 bg-gray-50 p-5 xl:col-span-3">
        ...
        <section className="rounded-[11px] border border-slate-200 bg-gray-50 p-5 xl:col-span-5">
                    ...
                    return (
                      <div key={item.label} className="flex min-w-0 flex-1 flex-col items-center gap-2">
                        ...
                        <div className="mt-2 text-center">
                          <div
                            className={`text-sm font-semibold ${getStepLabelClassName(stepIndex, details.currentStep)}`}
                          >
                            {item.label}
                          </div>
